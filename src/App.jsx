...
const maharashtraCuisineData = [
  { dish_name:"Vada Pav", state:"Maharashtra", cuisine:"Indian", category:"Appetizers", difficulty_level:"Medium", prep_time_minutes:30, cook_time_minutes:20, servings:4, short_description:"Mumbai's most iconic street food — a spiced potato vada encased in crispy besan batter, served inside a soft pav with dry garlic chutney and green chutney.", ingredients:[{name:"Potatoes",quantity:"4",unit:"large"},{name:"Besan",quantity:"1",unit:"cup"},{name:"Pav buns",quantity:"4",unit:"pieces"},{name:"Dry garlic chutney",quantity:"4",unit:"tbsp"},{name:"Green chutney",quantity:"4",unit:"tbsp"},{name:"Mustard seeds",quantity:"1",unit:"tsp"},{name:"Turmeric",quantity:"0.5",unit:"tsp"},{name:"Green chili",quantity:"3",unit:"pieces"},{name:"Ginger",quantity:"1",unit:"inch"},{name:"Oil for frying",quantity:"2",unit:"cups"}], preparation_steps:["Boil and mash potatoes. Temper with mustard seeds, curry leaves, turmeric, ginger and green chili.","Shape into round balls.","Make besan batter with turmeric, red chili and salt.","Dip potato balls in batter and deep fry until golden and crispy.","Slit pav buns and apply dry garlic chutney on one side, green chutney on the other. Place hot vada inside and serve."], chef_notes:"The dry garlic chutney is the secret weapon of vada pav — roasted garlic, coconut and chili ground together.", serving_suggestions:"Serve with dry garlic chutney, green chutney and a fried green chili on the side.", flavor_profile:["spicy","savory","crispy"], dietary_tags:["Vegetarian"], tags:["Street Food","Mumbai","Iconic"], img:"https://images.unsplash.com/photo-1601050690597-df0568f70950?w=400&q=80" },
  { dish_name:"Misal Pav", state:"Maharashtra", cuisine:"Indian", category:"Appetizers", difficulty_level:"Medium", prep_time_minutes:20, cook_time_minutes:35, servings:4, short_description:"Fiery sprouted moth bean curry topped with farsan, onion, tomato and lemon juice, served alongside buttered pav. Maharashtra's beloved breakfast.", ingredients:[{name:"Sprouted moth beans (matki)",quantity:"300",unit:"g"},{name:"Pav buns",quantity:"8",unit:"pieces"},{name:"Onion",quantity:"2",unit:"medium"},{name:"Tomato",quantity:"2",unit:"medium"},{name:"Misal masala",quantity:"3",unit:"tbsp"},{name:"Farsan/sev",quantity:"1",unit:"cup"},{name:"Coconut, grated",quantity:"3",unit:"tbsp"},{name:"Oil",quantity:"3",unit:"tbsp"},{name:"Lemon juice",quantity:"2",unit:"tbsp"},{name:"Coriander",quantity:"3",unit:"tbsp"}], preparation_steps:["Cook sprouted matki until just tender but not mushy.","Dry roast coconut and grind with fried onion.","Heat oil, add onion-tomato masala with misal masala.","Add cooked matki and 300ml water. Simmer 20 minutes.","Serve in a bowl. Top with farsan, raw onion, tomato, coriander and lemon juice. Serve buttered pav on the side."], chef_notes:"Misal has regional variations — Pune misal is spicier, Nasik misal is sweeter. The kat (spicy gravy) is what makes it great.", serving_suggestions:"Serve with buttered pav, fresh onion, lemon and extra farsan on the side.", flavor_profile:["spicy","tangy","savory"], dietary_tags:["Vegetarian"], tags:["Street Food","Breakfast","Spicy"], img:"https://images.unsplash.com/photo-1567188040759-fb8a883dc6d8?w=400&q=80" },
  { dish_name:"Kanda Bhaji", state:"Maharashtra", cuisine:"Indian", category:"Appetizers", difficulty_level:"Easy", prep_time_minutes:10, cook_time_minutes:15, servings:4, short_description:"Irresistibly crispy onion fritters — a Maharashtrian monsoon staple. Thinly sliced onions in spiced besan batter, deep fried until golden.", ingredients:[{name:"Onions",quantity:"3",unit:"large"},{name:"Besan",quantity:"1",unit:"cup"},{name:"Rice flour",quantity:"3",unit:"tbsp"},{name:"Green chili",quantity:"3",unit:"pieces"},{name:"Coriander leaves",quantity:"3",unit:"tbsp"},{name:"Red chili powder",quantity:"1",unit:"tsp"},{name:"Ajwain",quantity:"0.5",unit:"tsp"},{name:"Oil for frying",quantity:"2",unit:"cups"},{name:"Salt",quantity:"1",unit:"tsp"}], preparation_steps:["Thinly slice onions and mix with salt. Let rest 5 minutes to release moisture.","Add besan, rice flour, green chili, coriander, chili powder and ajwain.","Mix well. The onion moisture should be enough — add minimal water.","Drop spoonfuls into hot oil and fry on medium heat.","Fry until deeply golden and crispy. Drain on paper."], chef_notes:"Rice flour is the secret to extra crispiness.", serving_suggestions:"Serve with green chutney and a cup of cutting chai on a rainy day.", flavor_profile:["crispy","savory","spicy"], dietary_tags:["Vegetarian"], tags:["Monsoon Snack","Tea Time"], img:"https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?w=400&q=80" },
  { dish_name:"Sabudana Vada", state:"Maharashtra", cuisine:"Indian", category:"Appetizers", difficulty_level:"Medium", prep_time_minutes:240, cook_time_minutes:20, servings:4, short_description:"Crispy shallow-fried patties made with soaked tapioca pearls, mashed potato and roasted peanuts. A popular Maharashtrian fasting food and monsoon snack.", ingredients:[{name:"Sabudana (tapioca pearls)",quantity:"250",unit:"g"},{name:"Potatoes",quantity:"2",unit:"medium"},{name:"Roasted peanuts, coarsely ground",quantity:"0.5",unit:"cup"},{name:"Green chili",quantity:"3",unit:"pieces"},{name:"Cumin seeds",quantity:"1",unit:"tsp"},{name:"Lemon juice",quantity:"1",unit:"tbsp"},{name:"Rock salt",quantity:"1",unit:"tsp"},{name:"Oil for frying",quantity:"4",unit:"tbsp"}], preparation_steps:["Soak sabudana in minimal water for 4 hours until pearls are soft.","Boil and mash potatoes until smooth.","Mix sabudana, potato, peanuts, green chili, cumin, lemon and coriander.","Shape into round flat patties.","Shallow fry in oil on medium heat until golden and crispy on both sides."], chef_notes:"The key is the correct sabudana soak — it should be just soft enough to press, not wet and sticky.", serving_suggestions:"Serve with green chutney and sweetened yogurt. Perfect for fasting days.", flavor_profile:["crispy","savory","nutty"], dietary_tags:["Fasting Food","Vegetarian","Gluten-Free"], tags:["Fasting Food","Street Food"], img:"https://images.unsplash.com/photo-1630851840633-f96999247032?w=400&q=80" },
  { dish_name:"Kanda Poha", state:"Maharashtra", cuisine:"Indian", category:"Appetizers", difficulty_level:"Easy", prep_time_minutes:10, cook_time_minutes:15, servings:4, short_description:"Maharashtra's quintessential breakfast — flattened rice tossed with sautéed onions, mustard, turmeric and curry leaves, finished with fresh coconut, coriander and lemon.", ingredients:[{name:"Thick poha (flattened rice)",quantity:"300",unit:"g"},{name:"Onion",quantity:"2",unit:"medium"},{name:"Green chili",quantity:"2",unit:"pieces"},{name:"Mustard seeds",quantity:"1",unit:"tsp"},{name:"Turmeric",quantity:"0.5",unit:"tsp"},{name:"Curry leaves",quantity:"10",unit:"pieces"},{name:"Grated coconut",quantity:"3",unit:"tbsp"},{name:"Lemon juice",quantity:"2",unit:"tbsp"},{name:"Oil",quantity:"3",unit:"tbsp"},{name:"Sugar",quantity:"1",unit:"tsp"}], preparation_steps:["Wash poha in a sieve until just moistened. Do not over-soak.","Heat oil, add mustard seeds, curry leaves and green chili.","Add sliced onion and fry until translucent.","Add turmeric and poha. Toss gently on low heat.","Remove from heat. Add lemon juice, coconut and coriander."], chef_notes:"Adding a small amount of sugar balances the lemon acidity — a signature Maharashtrian touch.", serving_suggestions:"Serve warm for breakfast with a cup of cutting chai.", flavor_profile:["savory","tangy","fresh"], dietary_tags:["Vegetarian"], tags:["Breakfast","Quick"], img:"https://images.unsplash.com/photo-1596797038530-2c107229654b?w=400&q=80" },
  { dish_name:"Katachi Amti", state:"Maharashtra", cuisine:"Indian", category:"Soups", difficulty_level:"Medium", prep_time_minutes:15, cook_time_minutes:30, servings:4, short_description:"A deeply flavored, spiced lentil soup made from the water left after cooking chana dal. A staple of Maharashtrian Puran Poli meals, tempered with coconut, tamarind and goda masala.", ingredients:[{name:"Chana dal cooking water",quantity:"500",unit:"ml"},{name:"Goda masala",quantity:"2",unit:"tsp"},{name:"Tamarind pulp",quantity:"2",unit:"tbsp"},{name:"Jaggery",quantity:"1",unit:"tbsp"},{name:"Coconut, grated",quantity:"3",unit:"tbsp"},{name:"Mustard seeds",quantity:"1",unit:"tsp"},{name:"Curry leaves",quantity:"10",unit:"pieces"},{name:"Ghee",quantity:"2",unit:"tbsp"},{name:"Turmeric",quantity:"0.5",unit:"tsp"},{name:"Salt",quantity:"1",unit:"tsp"}], preparation_steps:["Collect the water drained from cooked chana dal and keep aside.","Heat ghee in a pan and add mustard seeds. Let them splutter.","Add dried red chilies and curry leaves. Fry for 30 seconds.","Add tamarind pulp, jaggery and turmeric. Stir well.","Pour in the chana dal water, add goda masala and grated coconut. Simmer for 15 minutes."], chef_notes:"Goda masala is the soul of this recipe. Do not substitute with regular garam masala.", serving_suggestions:"Traditionally served as part of a Puran Poli thali.", nutrition_estimate:{calories:"145",protein_g:"6",carbohydrates_g:"18",fat_g:"5"}, flavor_profile:["savory","tangy","sweet-spicy"], dietary_tags:["Vegetarian"], tags:["Traditional","Festival Food"], img:"https://images.unsplash.com/photo-1547592166-23ac45744acd?w=400&q=80" },
  { dish_name:"Tomato Saar", state:"Maharashtra", cuisine:"Indian", category:"Soups", difficulty_level:"Easy", prep_time_minutes:10, cook_time_minutes:20, servings:4, short_description:"A thin, tangy and spiced tomato broth with coconut milk and aromatic spices — a beloved part of Maharashtrian thali.", ingredients:[{name:"Ripe tomatoes",quantity:"500",unit:"g"},{name:"Coconut milk",quantity:"200",unit:"ml"},{name:"Garlic",quantity:"5",unit:"cloves"},{name:"Ginger",quantity:"1",unit:"inch"},{name:"Green chili",quantity:"2",unit:"pieces"},{name:"Mustard seeds",quantity:"1",unit:"tsp"},{name:"Curry leaves",quantity:"8",unit:"pieces"},{name:"Ghee",quantity:"1",unit:"tbsp"},{name:"Jaggery",quantity:"1",unit:"tsp"},{name:"Salt",quantity:"1",unit:"tsp"}], preparation_steps:["Boil tomatoes until soft and blend into a smooth puree. Strain.","Heat ghee, add mustard seeds and curry leaves.","Add crushed garlic, ginger and green chili. Sauté briefly.","Pour in tomato puree and coconut milk. Stir well.","Add jaggery and salt. Simmer for 10 minutes."], chef_notes:"The jaggery balances the acidity of tomatoes. Coconut milk makes it creamy without being heavy.", serving_suggestions:"Serve in small cups as a starter or with steamed rice.", nutrition_estimate:{calories:"110",protein_g:"2",carbohydrates_g:"14",fat_g:"6"}, flavor_profile:["tangy","creamy","savory"], dietary_tags:["Vegetarian","Gluten-Free"], tags:["Traditional","Thali"], img:"https://images.unsplash.com/photo-1604152135912-04a022e23696?w=400&q=80" },
  { dish_name:"Kokum Saar", state:"Maharashtra", cuisine:"Indian", category:"Soups", difficulty_level:"Easy", prep_time_minutes:5, cook_time_minutes:15, servings:4, short_description:"A cooling, digestive soup from the Konkan coast — made with kokum, coconut milk and minimal spices. Light, tangy and deeply refreshing.", ingredients:[{name:"Dried kokum",quantity:"8",unit:"pieces"},{name:"Coconut milk",quantity:"250",unit:"ml"},{name:"Jaggery",quantity:"1",unit:"tbsp"},{name:"Green chili",quantity:"1",unit:"piece"},{name:"Cumin powder",quantity:"0.5",unit:"tsp"},{name:"Salt",quantity:"0.5",unit:"tsp"},{name:"Fresh coriander",quantity:"1",unit:"tbsp"}], preparation_steps:["Soak kokum in 300ml warm water for 15 minutes. Squeeze and extract the juice.","Combine kokum water with coconut milk in a pan.","Add jaggery, green chili, cumin powder and salt.","Heat gently without boiling — do not boil coconut milk.","Strain and serve garnished with fresh coriander."], chef_notes:"Never boil this saar vigorously as coconut milk will split.", serving_suggestions:"Serve chilled or warm as a digestive after a heavy meal.", nutrition_estimate:{calories:"95",protein_g:"1",carbohydrates_g:"12",fat_g:"5"}, flavor_profile:["cooling","tangy","creamy"], dietary_tags:["Vegan","Gluten-Free"], tags:["Konkan","Digestive"], img:"https://images.unsplash.com/photo-1576577445504-6af96477db52?w=400&q=80" },
  { dish_name:"Kachumber", state:"Maharashtra", cuisine:"Indian", category:"Salads", difficulty_level:"Easy", prep_time_minutes:10, cook_time_minutes:0, servings:4, short_description:"Maharashtra's essential salad — a refreshing mix of finely diced cucumber, tomato, onion, coriander and lemon juice.", ingredients:[{name:"Cucumber",quantity:"2",unit:"medium"},{name:"Tomato",quantity:"2",unit:"medium"},{name:"Onion",quantity:"1",unit:"medium"},{name:"Green chili",quantity:"1",unit:"piece"},{name:"Fresh coriander",quantity:"3",unit:"tbsp"},{name:"Lemon juice",quantity:"2",unit:"tbsp"},{name:"Salt",quantity:"0.5",unit:"tsp"},{name:"Roasted cumin powder",quantity:"0.5",unit:"tsp"}], preparation_steps:["Finely dice cucumber, tomato and onion into even small pieces.","Finely chop green chili and coriander.","Combine all ingredients in a bowl.","Add lemon juice, salt and roasted cumin powder.","Toss well and serve immediately."], chef_notes:"Always cut kachumber just before serving — it releases water if left too long.", serving_suggestions:"Serve alongside any Maharashtrian curry, dal-rice, or grilled meats.", nutrition_estimate:{calories:"45",protein_g:"2",carbohydrates_g:"9",fat_g:"0"}, flavor_profile:["fresh","crunchy","tangy"], dietary_tags:["Vegetarian","Vegan","Gluten-Free"], tags:["Salad","Everyday"], img:"https://images.unsplash.com/photo-1540420773420-3366772f4999?w=400&q=80" },
  { dish_name:"Bharli Vangi", state:"Maharashtra", cuisine:"Indian", category:"Main Courses", difficulty_level:"Medium", prep_time_minutes:25, cook_time_minutes:30, servings:4, short_description:"Maharashtra's crown jewel — small brinjals stuffed with a fragrant peanut-coconut-spice mixture and slow cooked in their own juices.", ingredients:[{name:"Small round brinjals",quantity:"8",unit:"pieces"},{name:"Roasted peanuts",quantity:"4",unit:"tbsp"},{name:"Grated coconut",quantity:"4",unit:"tbsp"},{name:"Onion",quantity:"1",unit:"medium"},{name:"Goda masala",quantity:"2",unit:"tsp"},{name:"Sesame seeds",quantity:"2",unit:"tbsp"},{name:"Tamarind",quantity:"1",unit:"tbsp"},{name:"Jaggery",quantity:"1",unit:"tsp"},{name:"Oil",quantity:"3",unit:"tbsp"},{name:"Salt",quantity:"1.5",unit:"tsp"}], preparation_steps:["Dry roast peanuts, coconut and sesame seeds. Grind with fried onion.","Mix ground masala with goda masala, tamarind, jaggery and salt.","Make criss-cross slits in brinjals keeping the stem intact.","Stuff each brinjal generously with the masala mixture.","Heat oil in a pan and cook stuffed brinjals covered on low heat for 25 minutes."], chef_notes:"Low and slow is the key to perfectly cooked bharli vangi.", serving_suggestions:"Serve with jowar bhakri, rice or roti and a bowl of varan.", nutrition_estimate:{calories:"265",protein_g:"7",carbohydrates_g:"22",fat_g:"17"}, flavor_profile:["savory","nutty","spiced"], dietary_tags:["Vegetarian"], tags:["Festival Food","Traditional","Signature Dish"], img:"https://images.unsplash.com/photo-1585032226651-759b368d7246?w=400&q=80" },
  { dish_name:"Chicken Kolhapuri", state:"Maharashtra", cuisine:"Indian", category:"Main Courses", difficulty_level:"Hard", prep_time_minutes:40, cook_time_minutes:60, servings:4, short_description:"One of India's most fiery and complex chicken dishes — a dark, aromatic and intensely spiced curry from Kolhapur made with fresh-ground Kolhapuri masala.", ingredients:[{name:"Chicken",quantity:"800",unit:"g"},{name:"Onions",quantity:"3",unit:"large"},{name:"Kolhapuri masala",quantity:"4",unit:"tbsp"},{name:"Dried red chilies",quantity:"8",unit:"pieces"},{name:"Grated coconut, dry roasted",quantity:"5",unit:"tbsp"},{name:"Ginger-garlic paste",quantity:"3",unit:"tbsp"},{name:"Sesame seeds, roasted",quantity:"2",unit:"tbsp"},{name:"Oil",quantity:"4",unit:"tbsp"},{name:"Salt",quantity:"2",unit:"tsp"}], preparation_steps:["Dry roast coconut, sesame and whole spices. Grind with soaked red chilies.","Fry onions until deep brown and caramelized.","Add ginger-garlic paste and fry until oil separates.","Add Kolhapuri masala and ground coconut-chili paste. Fry on low heat for 8 minutes.","Add chicken pieces, sear on high heat, add water, cover and cook 35-40 minutes."], chef_notes:"The depth of color in Kolhapuri chicken comes from deeply caramelized onions and dry roasted coconut.", serving_suggestions:"Serve with jowar bhakri, tandlachi bhakri or steamed rice.", nutrition_estimate:{calories:"380",protein_g:"32",carbohydrates_g:"12",fat_g:"22"}, flavor_profile:["spicy","smoky","bold"], dietary_tags:["Non-Vegetarian"], tags:["Spicy","Kolhapuri","Weekend Special"], img:"https://images.unsplash.com/photo-1574653853027-5382a3d23a15?w=400&q=80" },
  { dish_name:"Pav Bhaji", state:"Maharashtra", cuisine:"Indian", category:"Main Courses", difficulty_level:"Easy", prep_time_minutes:20, cook_time_minutes:30, servings:4, short_description:"Mumbai's greatest culinary invention — a buttery, spiced vegetable mash served with butter-toasted pav buns. A dish born in the textile mills of Mumbai.", ingredients:[{name:"Potatoes",quantity:"3",unit:"large"},{name:"Cauliflower",quantity:"1",unit:"small"},{name:"Green peas",quantity:"0.5",unit:"cup"},{name:"Tomatoes",quantity:"3",unit:"large"},{name:"Butter",quantity:"5",unit:"tbsp"},{name:"Onion",quantity:"2",unit:"large"},{name:"Capsicum",quantity:"1",unit:"medium"},{name:"Pav bhaji masala",quantity:"3",unit:"tbsp"},{name:"Pav buns",quantity:"8",unit:"pieces"}], preparation_steps:["Boil potatoes, cauliflower and peas until soft.","Heat butter in a wide pan. Fry onion until golden.","Add tomatoes and capsicum. Cook until mushy.","Add pav bhaji masala. Add boiled vegetables and mash together completely.","Add water to adjust consistency. Simmer 15 minutes. Toast pav with butter."], chef_notes:"The flat iron tawa and liberal butter are what make street-style pav bhaji special. Do not be shy with the butter.", serving_suggestions:"Serve piping hot bhaji with butter-toasted pav, raw onion, lemon wedge and coriander.", nutrition_estimate:{calories:"415",protein_g:"10",carbohydrates_g:"58",fat_g:"18"}, flavor_profile:["buttery","savory","spiced"], dietary_tags:["Vegetarian"], tags:["Street Food","Mumbai","Iconic"], img:"https://images.unsplash.com/photo-1603894584373-5ac82b2ae398?w=400&q=80" },
  { dish_name:"Puran Poli", state:"Maharashtra", cuisine:"Indian", category:"Breads", difficulty_level:"Hard", prep_time_minutes:60, cook_time_minutes:30, servings:4, short_description:"Maharashtra's most beloved festive flatbread — a thin whole wheat outer shell stuffed with a fragrant sweet filling of cooked chana dal, jaggery and cardamom.", ingredients:[{name:"Whole wheat flour",quantity:"300",unit:"g"},{name:"Chana dal",quantity:"200",unit:"g"},{name:"Jaggery",quantity:"200",unit:"g"},{name:"Cardamom powder",quantity:"1",unit:"tsp"},{name:"Nutmeg powder",quantity:"0.25",unit:"tsp"},{name:"Ghee",quantity:"6",unit:"tbsp"},{name:"Turmeric",quantity:"0.25",unit:"tsp"},{name:"Salt",quantity:"0.5",unit:"tsp"}], preparation_steps:["Make a soft, pliable dough with flour, turmeric, salt, oil and water. Rest 30 minutes.","Pressure cook chana dal until completely soft.","Mash dal and cook with jaggery until mixture thickens and leaves sides of pan.","Add cardamom and nutmeg. Cool completely — this is the puran.","Divide dough and puran into equal balls. Flatten dough, place puran, seal and roll gently. Cook on hot griddle with generous ghee on both sides."], chef_notes:"The puran must be very dry before stuffing — cook it until it holds its shape.", serving_suggestions:"Serve hot with katachi amti, ghee and a glass of milk.", nutrition_estimate:{calories:"420",protein_g:"10",carbohydrates_g:"68",fat_g:"12"}, flavor_profile:["sweet","aromatic","ghee"], dietary_tags:["Vegetarian"], tags:["Festival Food","Holi","Ganesh Chaturthi"], img:"https://images.unsplash.com/photo-1586444248902-2f64eddc13df?w=400&q=80" },
  { dish_name:"Jowar Bhakri", state:"Maharashtra", cuisine:"Indian", category:"Breads", difficulty_level:"Medium", prep_time_minutes:15, cook_time_minutes:20, servings:4, short_description:"Maharashtra's everyday sorghum flatbread — thick, rustic and nutritious. Made purely with jowar flour and water, best eaten fresh off the tawa with generous white butter.", ingredients:[{name:"Jowar flour (sorghum)",quantity:"300",unit:"g"},{name:"Warm water",quantity:"200",unit:"ml"},{name:"Salt",quantity:"0.5",unit:"tsp"},{name:"White butter (loni)",quantity:"4",unit:"tbsp"}], preparation_steps:["Mix jowar flour with warm water and salt. Knead into a soft dough.","Divide into medium balls.","Wet your palms with water and pat each ball into a thick round on a wet cloth.","Cook on a dry hot tawa (no oil) on medium heat.","Press gently with a cloth and cook until light brown spots appear. Serve with white butter."], chef_notes:"Jowar bhakri requires patience — it cannot be rolled like wheat roti. Always eat fresh as it hardens when cold.", serving_suggestions:"Serve hot with white butter, any Maharashtrian curry, or thecha (green chili chutney).", nutrition_estimate:{calories:"220",protein_g:"7",carbohydrates_g:"44",fat_g:"4"}, flavor_profile:["earthy","nutty","rustic"], dietary_tags:["Gluten-Free","Vegetarian"], tags:["Traditional","Everyday","Gluten-Free"], img:"https://images.unsplash.com/photo-1620921568790-c1cf8e1b4314?w=400&q=80" },
  { dish_name:"Shrikhand", state:"Maharashtra", cuisine:"Indian", category:"Desserts", difficulty_level:"Easy", prep_time_minutes:480, cook_time_minutes:0, servings:6, short_description:"Maharashtra's most beloved dessert — thick strained yogurt whipped with sugar, saffron, cardamom and garnished with pistachios. Creamy, fragrant and intensely flavored.", ingredients:[{name:"Full fat yogurt",quantity:"1",unit:"kg"},{name:"Powdered sugar",quantity:"200",unit:"g"},{name:"Saffron",quantity:"0.5",unit:"tsp"},{name:"Cardamom powder",quantity:"1",unit:"tsp"},{name:"Warm milk",quantity:"2",unit:"tbsp"},{name:"Pistachios",quantity:"2",unit:"tbsp"},{name:"Rose water",quantity:"1",unit:"tsp"}], preparation_steps:["Hang yogurt in a muslin cloth for 6-8 hours to drain all whey.","The resulting chakka should be very thick and dense.","Soak saffron in warm milk for 10 minutes.","Whisk chakka with powdered sugar until smooth.","Add cardamom, saffron milk and rose water. Chill for at least 2 hours before serving. Garnish with pistachios."], chef_notes:"The quality of shrikhand depends entirely on the chakka (strained yogurt). It must be hung long enough to eliminate all whey.", serving_suggestions:"Serve chilled as a dessert or with hot puri as Shrikhand-Puri.", nutrition_estimate:{calories:"285",protein_g:"7",carbohydrates_g:"42",fat_g:"10"}, flavor_profile:["sweet","creamy","saffron"], dietary_tags:["Vegetarian","Gluten-Free"], tags:["Dessert","Festival Food"], img:"https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=400&q=80" },
  { dish_name:"Ukadiche Modak", state:"Maharashtra", cuisine:"Indian", category:"Desserts", difficulty_level:"Hard", prep_time_minutes:60, cook_time_minutes:20, servings:4, short_description:"Steamed rice flour dumplings filled with a fragrant coconut-jaggery-cardamom filling. Lord Ganesha's favorite offering, made during Ganesh Chaturthi.", ingredients:[{name:"Rice flour",quantity:"300",unit:"g"},{name:"Grated coconut",quantity:"300",unit:"g"},{name:"Jaggery",quantity:"200",unit:"g"},{name:"Cardamom powder",quantity:"1",unit:"tsp"},{name:"Nutmeg",quantity:"0.25",unit:"tsp"},{name:"Ghee",quantity:"2",unit:"tbsp"},{name:"Salt",quantity:"0.25",unit:"tsp"}], preparation_steps:["Make filling: cook coconut with jaggery until dry. Add cardamom and nutmeg. Cool.","Boil 500ml water with ghee and salt. Add rice flour off heat and mix vigorously.","Knead dough while warm into a smooth ball using wet hands.","Take a small ball of dough, flatten in your palm, place filling in center, and pleat the edges together upward to form a pointed top.","Steam in a steamer lined with muslin for 12-15 minutes. Serve hot with a drizzle of ghee."], chef_notes:"The dough must be worked while warm. The pleating is a traditional art — 13 pleats is considered perfect.", serving_suggestions:"Serve as naivedyam (offering) to Lord Ganesha during Ganesh Chaturthi. Eat hot with ghee.", nutrition_estimate:{calories:"265",protein_g:"4",carbohydrates_g:"45",fat_g:"8"}, flavor_profile:["sweet","coconut","aromatic"], dietary_tags:["Vegetarian","Gluten-Free"], tags:["Festival Food","Ganesh Chaturthi"], img:"https://images.unsplash.com/photo-1563805042-7684c019e1cb?w=400&q=80" },
  { dish_name:"Basundi", state:"Maharashtra", cuisine:"Indian", category:"Desserts", difficulty_level:"Medium", prep_time_minutes:5, cook_time_minutes:90, servings:6, short_description:"A rich, thickened sweetened milk dessert — essentially a concentrated rabri flavored with saffron, cardamom and garnished with nuts. A festival and wedding staple.", ingredients:[{name:"Full fat milk",quantity:"1.5",unit:"litre"},{name:"Sugar",quantity:"150",unit:"g"},{name:"Saffron",quantity:"0.5",unit:"tsp"},{name:"Cardamom powder",quantity:"1",unit:"tsp"},{name:"Charoli nuts",quantity:"2",unit:"tbsp"},{name:"Almonds, sliced",quantity:"2",unit:"tbsp"},{name:"Rose water",quantity:"1",unit:"tsp"}], preparation_steps:["Bring milk to a boil in a wide heavy pan.","Reduce heat and simmer, stirring frequently, for 60-70 minutes.","The milk will reduce by half and thick cream layers will form.","Add sugar, saffron, cardamom and rose water.","Simmer another 15 minutes until thick and creamy. Serve warm or chilled, garnished with nuts."], chef_notes:"Basundi requires patience — do not rush the reduction. Keep scraping the cream from sides and mixing back in.", serving_suggestions:"Serve chilled as a dessert or warm as a festival offering.", nutrition_estimate:{calories:"310",protein_g:"9",carbohydrates_g:"38",fat_g:"14"}, flavor_profile:["sweet","creamy","saffron"], dietary_tags:["Vegetarian","Gluten-Free"], tags:["Dessert","Festival Food"], img:"https://images.unsplash.com/photo-1558024920-b41e1887dc32?w=400&q=80" },
  { dish_name:"Cutting Chai", state:"Maharashtra", cuisine:"Indian", category:"Tea", difficulty_level:"Easy", prep_time_minutes:2, cook_time_minutes:8, servings:2, short_description:"Mumbai's iconic half-cup strong masala tea — served scalding hot in small glasses on street corners throughout the city. Bold, spiced and deeply satisfying.", ingredients:[{name:"Water",quantity:"200",unit:"ml"},{name:"Milk",quantity:"150",unit:"ml"},{name:"Strong black tea leaves",quantity:"2",unit:"tsp"},{name:"Ginger",quantity:"1",unit:"inch"},{name:"Cardamom",quantity:"3",unit:"pods"},{name:"Sugar",quantity:"2",unit:"tsp"},{name:"Black pepper",quantity:"2",unit:"pieces"}], preparation_steps:["Crush cardamom and black pepper roughly.","Bring water to boil with crushed spices and grated ginger.","Add tea leaves and boil for 2 minutes.","Add milk and bring to a vigorous boil — let it rise twice.","Add sugar and strain into small glasses. Serve immediately."], chef_notes:"The double boil is crucial for that thick, strong Mumbai cutting chai character.", serving_suggestions:"Serve in small glasses with bun maska, vada pav or khari biscuit.", nutrition_estimate:{calories:"85",protein_g:"3",carbohydrates_g:"12",fat_g:"3"}, flavor_profile:["spiced","sweet","aromatic","warming"], dietary_tags:["Vegetarian"], tags:["Beverage","Mumbai","Street Food"], img:"https://images.unsplash.com/photo-1571934811356-5cc061b6821f?w=400&q=80" },
];

const punjabCuisineData = [
  { dish_name:"Dal Makhani", state:"Punjab", cuisine:"Indian", category:"Soups", difficulty_level:"Medium", prep_time_minutes:480, cook_time_minutes:60, servings:4, short_description:"Punjab's most iconic lentil preparation — black urad dal and rajma slow-cooked with butter, cream and tomatoes into a velvety, deeply satisfying dal that is the soul of Punjabi cooking.", ingredients:[{name:"Whole black urad dal",quantity:"200",unit:"g"},{name:"Rajma (kidney beans)",quantity:"50",unit:"g"},{name:"Butter",quantity:"4",unit:"tbsp"},{name:"Fresh cream",quantity:"100",unit:"ml"},{name:"Tomatoes",quantity:"3",unit:"medium"},{name:"Onion",quantity:"1",unit:"large"},{name:"Ginger-garlic paste",quantity:"2",unit:"tbsp"},{name:"Red chili powder",quantity:"1",unit:"tsp"},{name:"Garam masala",quantity:"1",unit:"tsp"},{name:"Salt",quantity:"1.5",unit:"tsp"}], preparation_steps:["Soak urad dal and rajma overnight in water.","Pressure cook together until completely soft — about 6-8 whistles.","Mash lightly and simmer on very low heat.","Heat butter and fry onion until golden. Add ginger-garlic paste, tomatoes and spices.","Add this masala to the dal and simmer on lowest heat for 30-45 minutes. Finish with cream and butter."], chef_notes:"The secret to restaurant-style Dal Makhani is the long slow simmer — the longer it cooks, the better it gets.", serving_suggestions:"Serve with butter naan, tandoori roti or jeera rice.", nutrition_estimate:{calories:"385",protein_g:"15",carbohydrates_g:"42",fat_g:"18"}, flavor_profile:["rich","creamy","slow-cooked"], dietary_tags:["Vegetarian"], tags:["Iconic","Slow Cooked","Punjabi"], img:"https://images.unsplash.com/photo-1547592166-23ac45744acd?w=400&q=80" },
  { dish_name:"Tamatar Shorba", state:"Punjab", cuisine:"Indian", category:"Soups", difficulty_level:"Easy", prep_time_minutes:10, cook_time_minutes:25, servings:4, short_description:"A classic North Indian restaurant soup — a thin, spiced tomato broth with ginger, garlic and whole spices, finished with cream.", ingredients:[{name:"Ripe tomatoes",quantity:"600",unit:"g"},{name:"Onion",quantity:"1",unit:"medium"},{name:"Ginger",quantity:"1",unit:"inch"},{name:"Garlic",quantity:"3",unit:"cloves"},{name:"Fresh cream",quantity:"3",unit:"tbsp"},{name:"Butter",quantity:"2",unit:"tbsp"},{name:"Sugar",quantity:"1",unit:"tsp"},{name:"Salt",quantity:"1",unit:"tsp"},{name:"Coriander",quantity:"2",unit:"tbsp"}], preparation_steps:["Roast tomatoes, onion, ginger and garlic together.","Blend until smooth and strain.","Heat butter with whole spices.","Add strained tomato liquid.","Add sugar, salt and simmer 15 minutes. Finish with cream. Garnish with coriander."], chef_notes:"Roasting the tomatoes adds a depth of flavor that boiled tomatoes cannot achieve.", serving_suggestions:"Serve as a restaurant-style starter before Punjabi curries.", nutrition_estimate:{calories:"105",protein_g:"2",carbohydrates_g:"12",fat_g:"6"}, flavor_profile:["tangy","savory","creamy"], dietary_tags:["Vegetarian"], tags:["Restaurant Style","Soup","Classic"], img:"https://images.unsplash.com/photo-1604152135912-04a022e23696?w=400&q=80" },
  { dish_name:"Amritsari Machhi", state:"Punjab", cuisine:"Indian", category:"Appetizers", difficulty_level:"Medium", prep_time_minutes:30, cook_time_minutes:20, servings:4, short_description:"The legendary crispy fried fish from Amritsar — marinated in a spiced besan-ajwain batter and deep fried to a glorious golden crunch. Served with green chutney and onion rings.", ingredients:[{name:"Fish fillets (sole or pomfret)",quantity:"600",unit:"g"},{name:"Besan",quantity:"6",unit:"tbsp"},{name:"Rice flour",quantity:"2",unit:"tbsp"},{name:"Ajwain (carom seeds)",quantity:"1",unit:"tsp"},{name:"Ginger-garlic paste",quantity:"2",unit:"tbsp"},{name:"Kashmiri red chili",quantity:"2",unit:"tsp"},{name:"Amchur (dry mango powder)",quantity:"1",unit:"tsp"},{name:"Lemon juice",quantity:"2",unit:"tbsp"},{name:"Oil for frying",quantity:"2",unit:"cups"},{name:"Salt",quantity:"1.5",unit:"tsp"}], preparation_steps:["Clean fish and make cuts on both sides for marinade penetration.","Marinate with ginger-garlic paste, lemon, chili, amchur and salt for 20 minutes.","Make a thick batter with besan, rice flour, ajwain and water.","Dip marinated fish in batter.","Deep fry in hot oil until golden and crispy — about 4 minutes each side."], chef_notes:"Ajwain (carom seeds) is what makes this distinctly Amritsari. The double coating ensures the fish stays juicy inside while being incredibly crispy outside.", serving_suggestions:"Serve with green chutney, sliced onion rings and lemon wedges.", nutrition_estimate:{calories:"310",protein_g:"28",carbohydrates_g:"18",fat_g:"14"}, flavor_profile:["crispy","savory","tangy"], dietary_tags:["Non-Vegetarian"], tags:["Amritsar","Street Food","Crispy"], img:"https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=400&q=80" },
  { dish_name:"Tandoori Chicken", state:"Punjab", cuisine:"Indian", category:"Appetizers", difficulty_level:"Medium", prep_time_minutes:480, cook_time_minutes:30, servings:4, short_description:"Punjab's greatest gift to the world — chicken marinated in yogurt and spices then roasted in a blazing tandoor until charred and smoky.", ingredients:[{name:"Chicken legs and thighs",quantity:"800",unit:"g"},{name:"Thick yogurt",quantity:"200",unit:"g"},{name:"Kashmiri red chili powder",quantity:"3",unit:"tsp"},{name:"Ginger-garlic paste",quantity:"3",unit:"tbsp"},{name:"Mustard oil",quantity:"2",unit:"tbsp"},{name:"Lemon juice",quantity:"3",unit:"tbsp"},{name:"Garam masala",quantity:"1",unit:"tsp"},{name:"Salt",quantity:"2",unit:"tsp"}], preparation_steps:["Score chicken pieces deeply with a sharp knife.","First marinade: apply lemon juice, salt and chili for 30 minutes.","Second marinade: mix yogurt, ginger-garlic paste, mustard oil and all spices.","Coat chicken thoroughly and refrigerate overnight.","Cook in a very hot oven at 240°C or on a grill for 25-30 minutes turning once until charred on edges."], chef_notes:"Mustard oil is essential for authentic Tandoori flavor. Overnight marination makes all the difference.", serving_suggestions:"Serve with mint chutney, sliced onion, lemon wedges and laccha paratha.", nutrition_estimate:{calories:"295",protein_g:"35",carbohydrates_g:"5",fat_g:"14"}, flavor_profile:["smoky","spicy","charred"], dietary_tags:["Non-Vegetarian"], tags:["Iconic","Grilled","Tandoor"], img:"https://images.unsplash.com/photo-1603894584373-5ac82b2ae398?w=400&q=80" },
  { dish_name:"Punjabi Kachumber", state:"Punjab", cuisine:"Indian", category:"Salads", difficulty_level:"Easy", prep_time_minutes:10, cook_time_minutes:0, servings:4, short_description:"A bold, crunchy raw salad of cucumber, tomato, onion and radish — seasoned assertively with black salt, chaat masala and lemon. The perfect cooling counterpoint to rich Punjabi curries.", ingredients:[{name:"Cucumber",quantity:"2",unit:"medium"},{name:"Tomato",quantity:"2",unit:"medium"},{name:"Onion",quantity:"1",unit:"large"},{name:"Radish",quantity:"2",unit:"medium"},{name:"Green chili",quantity:"1",unit:"piece"},{name:"Lemon juice",quantity:"2",unit:"tbsp"},{name:"Black salt",quantity:"0.5",unit:"tsp"},{name:"Chaat masala",quantity:"0.5",unit:"tsp"},{name:"Coriander",quantity:"3",unit:"tbsp"}], preparation_steps:["Dice all vegetables into even small pieces.","Mix together in a bowl.","Add black salt, chaat masala and lemon juice.","Toss well.","Garnish with coriander and green chili. Serve immediately."], chef_notes:"Radish is the Punjabi element that sets this apart from other kachumbers. Black salt and chaat masala give it a distinctly North Indian character.", serving_suggestions:"Serve alongside any Punjabi main course as a cooling salad.", nutrition_estimate:{calories:"50",protein_g:"2",carbohydrates_g:"10",fat_g:"0"}, flavor_profile:["crunchy","tangy","fresh"], dietary_tags:["Vegan","Gluten-Free"], tags:["Salad","Everyday","Refreshing"], img:"https://images.unsplash.com/photo-1540420773420-3366772f4999?w=400&q=80" },
  { dish_name:"Sarson Ka Saag", state:"Punjab", cuisine:"Indian", category:"Main Courses", difficulty_level:"Medium", prep_time_minutes:20, cook_time_minutes:60, servings:4, short_description:"Punjab's most beloved winter dish — mustard greens slow-cooked with spinach and spices into a thick, earthy and deeply nourishing preparation. Served with makki di roti and white butter.", ingredients:[{name:"Mustard greens (sarson)",quantity:"500",unit:"g"},{name:"Spinach",quantity:"200",unit:"g"},{name:"Bathua (chenopodium)",quantity:"100",unit:"g"},{name:"Onion",quantity:"2",unit:"medium"},{name:"Ginger",quantity:"2",unit:"inch"},{name:"Garlic",quantity:"6",unit:"cloves"},{name:"Green chili",quantity:"3",unit:"pieces"},{name:"Maize flour (makki atta)",quantity:"2",unit:"tbsp"},{name:"Butter",quantity:"4",unit:"tbsp"},{name:"Salt",quantity:"1.5",unit:"tsp"}], preparation_steps:["Wash and roughly chop all greens.","Pressure cook greens with ginger, garlic and green chili for 3 whistles.","Blend coarsely — do not make smooth.","Add maize flour and cook stirring for 20 minutes.","Prepare tempering with butter and golden onion. Add to saag. Simmer 15 more minutes."], chef_notes:"Bathua (wild spinach) is essential for authentic sarson ka saag — it adds a distinctive earthiness. Maize flour thickens the saag.", serving_suggestions:"Serve with makki di roti, white butter (makkhan) and jaggery.", nutrition_estimate:{calories:"185",protein_g:"6",carbohydrates_g:"18",fat_g:"10"}, flavor_profile:["earthy","buttery","savory"], dietary_tags:["Vegetarian"], tags:["Winter Special","Iconic","Punjabi"], img:"https://images.unsplash.com/photo-1585032226651-759b368d7246?w=400&q=80" },
  { dish_name:"Butter Chicken (Murgh Makhani)", state:"Punjab", cuisine:"Indian", category:"Main Courses", difficulty_level:"Medium", prep_time_minutes:40, cook_time_minutes:45, servings:4, short_description:"India's most famous dish — tandoor-roasted chicken in a velvety tomato-butter-cream sauce. Mildly spiced and universally beloved.", ingredients:[{name:"Chicken",quantity:"800",unit:"g"},{name:"Butter",quantity:"5",unit:"tbsp"},{name:"Fresh cream",quantity:"150",unit:"ml"},{name:"Tomatoes",quantity:"4",unit:"large"},{name:"Cashews",quantity:"3",unit:"tbsp"},{name:"Onion",quantity:"2",unit:"medium"},{name:"Ginger-garlic paste",quantity:"2",unit:"tbsp"},{name:"Kashmiri red chili powder",quantity:"2",unit:"tsp"},{name:"Kasuri methi",quantity:"1",unit:"tbsp"},{name:"Garam masala",quantity:"1",unit:"tsp"}], preparation_steps:["Marinate chicken in yogurt, ginger-garlic paste, Kashmiri chili and spices for 4 hours.","Grill or cook chicken in a very hot pan until charred. Set aside.","Cook onion, tomatoes and cashews together until soft. Blend smooth.","Heat butter, add the blended sauce and cook for 15 minutes with all spices.","Add grilled chicken pieces, simmer 15 minutes. Finish with cream and kasuri methi."], chef_notes:"Kasuri methi (dried fenugreek) is the secret ingredient that gives Murgh Makhani its distinctive restaurant aroma.", serving_suggestions:"Serve with butter naan, laccha paratha or steamed basmati rice.", nutrition_estimate:{calories:"420",protein_g:"32",carbohydrates_g:"14",fat_g:"26"}, flavor_profile:["creamy","mildly spicy","savory"], dietary_tags:["Non-Vegetarian"], tags:["Iconic","Creamy","Punjabi"], img:"https://images.unsplash.com/photo-1603894584373-5ac82b2ae398?w=400&q=80" },
  { dish_name:"Chole Bhature", state:"Punjab", cuisine:"Indian", category:"Main Courses", difficulty_level:"Medium", prep_time_minutes:480, cook_time_minutes:60, servings:4, short_description:"Punjab's most iconic breakfast and brunch dish — deeply spiced chickpeas served with pillowy deep-fried bread.", ingredients:[{name:"Dried chickpeas (kabuli chana)",quantity:"300",unit:"g"},{name:"Tea bag",quantity:"1",unit:"piece"},{name:"Onions",quantity:"3",unit:"large"},{name:"Tomatoes",quantity:"3",unit:"large"},{name:"Chole masala",quantity:"3",unit:"tbsp"},{name:"Ginger-garlic paste",quantity:"2",unit:"tbsp"},{name:"Amchur",quantity:"1",unit:"tsp"},{name:"Maida (for bhature)",quantity:"300",unit:"g"},{name:"Yogurt (for bhature)",quantity:"100",unit:"g"},{name:"Oil for frying",quantity:"2",unit:"cups"}], preparation_steps:["Soak chickpeas overnight. Pressure cook with tea bag for dark color.","Fry onions until deep brown. Add ginger-garlic paste and tomatoes.","Add chole masala and amchur. Cook until oil separates.","Add cooked chickpeas and mash some for thick gravy. Simmer 20 minutes.","For bhature: knead maida with yogurt, salt and water into soft dough. Rest 2 hours. Roll into oval shapes and deep fry until puffed and golden."], chef_notes:"The tea bag trick gives chole its characteristic dark color naturally.", serving_suggestions:"Serve with pickled onions, green chili, mango pickle and lassi.", nutrition_estimate:{calories:"580",protein_g:"18",carbohydrates_g:"72",fat_g:"24"}, flavor_profile:["bold","spiced","tangy"], dietary_tags:["Vegetarian"], tags:["Street Food","Breakfast","Iconic"], img:"https://images.unsplash.com/photo-1601050690597-df0568f70950?w=400&q=80" },
  { dish_name:"Makki Di Roti", state:"Punjab", cuisine:"Indian", category:"Breads", difficulty_level:"Medium", prep_time_minutes:15, cook_time_minutes:20, servings:4, short_description:"Punjab's iconic cornmeal flatbread — thick, rustic and slightly sweet, best eaten hot off the tawa with sarson ka saag and a generous knob of white butter.", ingredients:[{name:"Maize flour (makki atta)",quantity:"300",unit:"g"},{name:"Warm water",quantity:"200",unit:"ml"},{name:"Salt",quantity:"0.5",unit:"tsp"},{name:"White butter (makkhan)",quantity:"4",unit:"tbsp"}], preparation_steps:["Mix maize flour with salt and warm water.","Knead into a soft dough — maize has no gluten so it will be crumbly.","Divide into balls and flatten on a wet cloth.","Carefully transfer to a hot dry tawa.","Cook on medium heat, pressing gently with a wet hand. Cook on both sides until golden. Apply white butter."], chef_notes:"Makki roti is gluten-free and requires patience to roll — use wet hands and a plastic sheet. Always eat fresh and hot as it hardens when cold.", serving_suggestions:"Serve hot with sarson ka saag, white butter and jaggery.", nutrition_estimate:{calories:"240",protein_g:"5",carbohydrates_g:"46",fat_g:"5"}, flavor_profile:["earthy","slightly sweet","nutty"], dietary_tags:["Gluten-Free","Vegetarian"], tags:["Winter Special","Traditional","Gluten-Free"], img:"https://images.unsplash.com/photo-1620921568790-c1cf8e1b4314?w=400&q=80" },
  { dish_name:"Butter Naan", state:"Punjab", cuisine:"Indian", category:"Breads", difficulty_level:"Medium", prep_time_minutes:120, cook_time_minutes:20, servings:4, short_description:"Punjab's most celebrated bread — a leavened, pillowy flatbread cooked in a blazing tandoor and brushed with generous amounts of butter. Soft, slightly charred and irresistibly good.", ingredients:[{name:"All-purpose flour (maida)",quantity:"400",unit:"g"},{name:"Yogurt",quantity:"100",unit:"g"},{name:"Instant yeast",quantity:"5",unit:"g"},{name:"Sugar",quantity:"1",unit:"tsp"},{name:"Butter",quantity:"5",unit:"tbsp"},{name:"Milk",quantity:"100",unit:"ml"},{name:"Nigella seeds (kalonji)",quantity:"1",unit:"tsp"},{name:"Salt",quantity:"1",unit:"tsp"}], preparation_steps:["Activate yeast in warm milk with sugar for 10 minutes.","Mix flour, yogurt, salt and yeast mixture. Knead 10 minutes.","Rest covered for 1.5 hours until doubled.","Divide into balls and roll into teardrop shapes. Press nigella seeds on top.","Cook on a very hot tawa or under a grill until puffed and charred. Brush generously with butter."], chef_notes:"The hotter the cooking surface, the better the naan. Brushing with butter while hot is non-negotiable.", serving_suggestions:"Serve with dal makhani, butter chicken, paneer dishes or any Punjabi curry.", nutrition_estimate:{calories:"290",protein_g:"7",carbohydrates_g:"46",fat_g:"9"}, flavor_profile:["buttery","pillowy","charred"], dietary_tags:["Vegetarian"], tags:["Iconic","Bread","Tandoor"], img:"https://images.unsplash.com/photo-1586444248902-2f64eddc13df?w=400&q=80" },
  { dish_name:"Aloo Paratha", state:"Punjab", cuisine:"Indian", category:"Breads", difficulty_level:"Easy", prep_time_minutes:30, cook_time_minutes:20, servings:4, short_description:"Punjab's most beloved stuffed flatbread — whole wheat dough filled with spiced mashed potatoes and cooked on a tawa with generous amounts of butter or ghee.", ingredients:[{name:"Whole wheat flour",quantity:"300",unit:"g"},{name:"Potatoes",quantity:"4",unit:"large"},{name:"Green chili",quantity:"2",unit:"pieces"},{name:"Ginger",quantity:"1",unit:"inch"},{name:"Coriander leaves",quantity:"3",unit:"tbsp"},{name:"Ajwain",quantity:"0.5",unit:"tsp"},{name:"Amchur",quantity:"0.5",unit:"tsp"},{name:"Butter",quantity:"5",unit:"tbsp"},{name:"Salt",quantity:"1.5",unit:"tsp"}], preparation_steps:["Knead wheat flour into soft dough. Rest 20 minutes.","Boil and mash potatoes completely smooth.","Mix mashed potato with green chili, ginger, coriander, ajwain, amchur and salt.","Roll dough ball into a small circle, place potato filling, seal completely.","Roll gently into a large circle — filling should not tear through. Cook on hot tawa with generous butter on both sides."], chef_notes:"The potato filling must be completely dry and lump-free — any moisture will cause the paratha to tear while rolling.", serving_suggestions:"Serve with white butter, yogurt, mango pickle and a glass of lassi.", nutrition_estimate:{calories:"380",protein_g:"9",carbohydrates_g:"56",fat_g:"14"}, flavor_profile:["buttery","savory","spiced"], dietary_tags:["Vegetarian"], tags:["Breakfast","Stuffed Bread","Punjabi"], img:"https://images.unsplash.com/photo-1620921568790-c1cf8e1b4314?w=400&q=80" },
  { dish_name:"Punjabi Sweet Lassi", state:"Punjab", cuisine:"Indian", category:"Sides", difficulty_level:"Easy", prep_time_minutes:10, cook_time_minutes:0, servings:2, short_description:"The world's most famous yogurt drink — thick, creamy, chilled and topped with a layer of malai (cream). Served in tall clay glasses.", ingredients:[{name:"Full fat yogurt",quantity:"400",unit:"g"},{name:"Sugar",quantity:"3",unit:"tbsp"},{name:"Chilled water or milk",quantity:"150",unit:"ml"},{name:"Rose water",quantity:"1",unit:"tsp"},{name:"Malai (cream layer)",quantity:"3",unit:"tbsp"},{name:"Cardamom powder",quantity:"0.25",unit:"tsp"},{name:"Ice cubes",quantity:"6",unit:"pieces"}], preparation_steps:["Blend yogurt with sugar, cardamom and water until frothy.","Add rose water and blend briefly.","Pour into tall chilled glasses with ice.","Top with a generous layer of malai (cream).","Serve immediately."], chef_notes:"The malai (cream) layer on top is the signature of authentic Punjabi lassi — never skip it.", serving_suggestions:"Serve with chole bhature, aloo paratha or any Punjabi breakfast.", nutrition_estimate:{calories:"245",protein_g:"8",carbohydrates_g:"30",fat_g:"11"}, flavor_profile:["sweet","creamy","refreshing"], dietary_tags:["Vegetarian"], tags:["Beverage","Summer Drink","Iconic"], img:"https://images.unsplash.com/photo-1527904324834-3bda86da6771?w=400&q=80" },
  { dish_name:"Gajar Ka Halwa", state:"Punjab", cuisine:"Indian", category:"Desserts", difficulty_level:"Medium", prep_time_minutes:20, cook_time_minutes:60, servings:6, short_description:"Punjab's quintessential winter dessert — grated red Delhi carrots slow-cooked in milk with ghee, sugar and cardamom until caramelized and deeply fragrant.", ingredients:[{name:"Red carrots (Delhi gajar)",quantity:"1",unit:"kg"},{name:"Full fat milk",quantity:"500",unit:"ml"},{name:"Sugar",quantity:"150",unit:"g"},{name:"Ghee",quantity:"4",unit:"tbsp"},{name:"Khoya",quantity:"100",unit:"g"},{name:"Cardamom powder",quantity:"1",unit:"tsp"},{name:"Almonds",quantity:"3",unit:"tbsp"},{name:"Cashews",quantity:"2",unit:"tbsp"}], preparation_steps:["Peel and grate carrots on the fine side of the grater.","Cook grated carrots with milk in a heavy pan on medium heat.","Stir frequently until all milk is absorbed — about 30 minutes.","Add ghee and fry carrots until they start to change color.","Add sugar and continue cooking until moisture evaporates. Add khoya and cardamom. Fry nuts in ghee and add. Serve warm."], chef_notes:"Red Delhi carrots (available November-February) give the best color and sweetness. The frying step after milk absorption caramelizes the sugars.", serving_suggestions:"Serve warm topped with a scoop of vanilla ice cream or rabri.", nutrition_estimate:{calories:"340",protein_g:"7",carbohydrates_g:"46",fat_g:"15"}, flavor_profile:["sweet","caramelized","warming"], dietary_tags:["Vegetarian"], tags:["Winter Special","Festival Sweet","Classic"], img:"https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=400&q=80" },
  { dish_name:"Punjabi Masala Chai", state:"Punjab", cuisine:"Indian", category:"Tea", difficulty_level:"Easy", prep_time_minutes:2, cook_time_minutes:8, servings:2, short_description:"The strongest, most aromatic of all Indian masala teas — made with full-fat milk, robust tea leaves, fresh ginger, cardamom and a generous hand with spices. Bold, thick and deeply warming.", ingredients:[{name:"Water",quantity:"200",unit:"ml"},{name:"Full fat milk",quantity:"200",unit:"ml"},{name:"Strong CTC tea leaves",quantity:"2.5",unit:"tsp"},{name:"Ginger",quantity:"1.5",unit:"inch"},{name:"Cardamom",quantity:"4",unit:"pods"},{name:"Black pepper",quantity:"3",unit:"pieces"},{name:"Cinnamon",quantity:"0.5",unit:"inch"},{name:"Sugar",quantity:"2",unit:"tsp"}], preparation_steps:["Crush cardamom, black pepper and cinnamon.","Bring water to boil with crushed spices and grated ginger.","Add tea leaves and boil vigorously for 2 minutes.","Add milk and bring to a full rolling boil twice.","Add sugar. Strain into cups and serve immediately."], chef_notes:"Punjabi chai must be strong and milky — the double boil is essential. CTC tea gives the right strength.", serving_suggestions:"Serve with aloo paratha, samosa or any Punjabi snack.", nutrition_estimate:{calories:"95",protein_g:"4",carbohydrates_g:"12",fat_g:"4"}, flavor_profile:["spiced","bold","aromatic","warming"], dietary_tags:["Vegetarian"], tags:["Beverage","Morning Ritual","Warming"], img:"https://images.unsplash.com/photo-1571934811356-5cc061b6821f?w=400&q=80" },
];
